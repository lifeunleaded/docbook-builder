...
for builtbook in built:
    ...
    published.write('<p>Last build {} due to <a href="https://git.sandvine.com/docs/xmldocs/commit/{}">{}</a></p></li>'.format(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), hc.hexsha, hc.hexsha))
